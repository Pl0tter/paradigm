...
# передаем usd_handler как преемника для eur_handler
eur_handler = EURHandler(usd_handler)
# передаем eur_handler как преемника для gbp_handler
gbp_handler = GBPHandler(eur_handler)
